...
export default function AddAdmConsultantPage() {
    ...
    <>
      <div className={styles.contentHeader}>
        <div className={styles.contentHeaderInner}>
          <h1 className={styles.pageTitle}>상임고문 추가</h1>
          <Link href="/dashboard/adm-consultants" className={styles.backLink}>
            목록으로
          </Link>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.formGroup}>
            ...
            {!scriptsReady ? (
              ...
              <div ref={editorRef} id="summernote-consultant-profile" />
            )}
          </div>
          <div className={styles.formGroup}>
