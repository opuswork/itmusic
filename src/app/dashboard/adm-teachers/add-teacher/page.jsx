...
export default function AddAdmTeacherPage() {
    ...
    <>
      <div className={styles.contentHeader}>
        <div className={styles.contentHeaderInner}>
          <h1 className={styles.pageTitle}>지도위원 추가</h1>
          <Link href="/dashboard/adm-teachers" className={styles.backLink}>
            목록으로
          </Link>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.formGroup}>
            ...
            {!scriptsReady ? (
              ...
              <div ref={editorRef} id="summernote-teacher-profile" />
            )}
          </div>
          <div className={styles.formGroup}>
