...
export default function AddAdmDirectorPage() {
    ...
    <>
      <div className={styles.contentHeader}>
        <div className={styles.contentHeaderInner}>
          <h1 className={styles.pageTitle}>음악감독 추가</h1>
          <Link href="/dashboard/adm-director" className={styles.backLink}>
            목록으로
          </Link>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.formGroup}>
            ...
            {!scriptsReady ? (
              ...
              <div ref={editorRef} id="summernote-director-text" />
            )}
          </div>
          <div className={styles.formGroup}>
