...
export default function AddAdmNoticePage() {
    ...
    <>
      <div className={styles.contentHeader}>
        <div className={styles.contentHeaderInner}>
          <h1 className={styles.pageTitle}>공지사항 추가</h1>
          <Link href="/dashboard/adm-notice" className={styles.backLink}>
            목록으로
          </Link>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.formGroup}>
            ...
            {!scriptsReady ? (
              ...
              <div ref={editorRef} id="summernote-notice-content" />
            )}
          </div>
          <div className={styles.formGroup}>
